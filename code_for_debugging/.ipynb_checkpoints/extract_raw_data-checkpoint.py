...
if __name__ == "__main__":
    ...
    fn_list = sys.argv[1]
    dir_path = '/global/cscratch1/sd/muszyng/ethz_data/project_atmo_block_datasets/dataset_1980-1998-2000-2016/climate_mod_output/' #sys.argv[2]
    ...
    out_path = '/global/cscratch1/sd/muszyng/ethz_data/project_atmo_block_datasets/generated_datasets/extracted_raw_data/v/test'
    ...
    for i in range(19,20):
        ...
        extract_regions(f_var[0,1,:,:], d_reg_loc, d_reg_bin_masks)
