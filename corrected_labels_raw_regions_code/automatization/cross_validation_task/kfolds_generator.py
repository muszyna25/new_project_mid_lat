...
def generate_k_triples(folds, kfolds):
    D = {'LTRAINS': [], 'LVALS': [], 'LTESTS': []}
...
if __name__ == "__main__":
    ...
    print(sys.argv[0], input_path, output_path)
    ...
    kfolds = 10
    msets = 10
    fold_size= int(n/kfolds)

    folds = [N[i:i + fold_size] for i in range(0, N.shape[0], fold_size)]
    print(folds)
