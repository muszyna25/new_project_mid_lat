...
if __name__ == "__main__":
    ...
    save_to_hdf5_format(X_n, Y, var + '_norm_train.h5', output_path)
    ...
    save_to_hdf5_format(X_val, Y_v, var + '_norm_val.h5', output_path)
    ...
    save_to_hdf5_format(X_test, Y_t, var + '_norm_test.h5', output_path)
