...
######################################## Settings ########################################
WORK_DIR="/global/cscratch1/sd/muszyng/ethz_data/project_atmo_block_datasets/generated_datasets/data_classification_regression/data_for_paper"
...
VAR='pv'             # Variable in ERA-interim data. If VAR='x' then take all variables.
...
PATH_LABELS="/global/cscratch1/sd/muszyng/ethz_data/project_atmo_block_datasets/generated_datasets/data_classification_regression/new"
OUT_LABELS_PATH="${PATH_LABELS}/labels"
...
OUT_CHUNK_FILES_HDF5="${OUT_BIG_FILES_HDF5}/chunk_files/small_chunks"
