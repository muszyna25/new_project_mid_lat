...
if __name__ == "__main__":
    ...
    for i in range(0, len(df_list)):
        ...
        X_bm, Y_bm, Z_bm, A_bm = read_data_hdf5(dir_path_bin_masks + '/' + f)
        X_raw, Y_raw, Z_raw, A_raw = read_data_hdf5(dir_path_era_raw + '/' + f)
        ...
        save_to_hdf5_format(X, Y, Z, A, file_name, out_path)
