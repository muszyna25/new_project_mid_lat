...
OUT_PATH="/global/cscratch1/sd/muszyng/ethz_data/project_atmo_block_datasets/generated_datasets/data_classification_regression/data_for_paper/all_data_v2"
...
SOURCE_A="${WORK_DIR}/u/big_hdf5_files/chunk_files/small_chunks"
SOURCE_B="${WORK_DIR}/v/big_hdf5_files/chunk_files/small_chunks"
SOURCE_C="${WORK_DIR}/pv/big_hdf5_files/chunk_files/small_chunks"
SOURCE_D="${WORK_DIR}/t/big_hdf5_files/chunk_files/small_chunks"
SOURCE_E="${WORK_DIR}/z/big_hdf5_files/chunk_files/small_chunks"
