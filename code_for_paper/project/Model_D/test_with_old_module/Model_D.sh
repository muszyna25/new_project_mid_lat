...
./startCluster.sh & sleep 60 && module use /global/common/cori_cle6/software/modulefiles && module load tensorflow/intel-1.13.1-py36 && python test_ipyparallel.py ${1} ${2} ${3} ${4} & wait
