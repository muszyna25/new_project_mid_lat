...
if __name__ == "__main__":
    ...
    n_convs_layers = 4
    #layer_sizes = np.array([8, 16, 32, 64])
    ...
    dropout = np.random.uniform(0.10, 0.15, size=n_hpo_trials)
    #dropout = np.random.uniform(0.5, 0.10, size=n_hpo_trials)
    ...
    # (n layer, k times)
    #repeats_conv = []
    #repeats_conv = [(0,1), (1,1)]
    repeats_conv = [(0,1), (1,1), (2,1)]
