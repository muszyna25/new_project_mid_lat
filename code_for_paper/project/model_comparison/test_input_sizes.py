...
_path = '/global/cscratch1/sd/muszyng/ethz_data/project_atmo_block_datasets/generated_datasets/data_classification_regression/data_for_paper/all_data_v2/out_regres_data/'
...
for fn in lfs:
    ...
    print('reading file....')
    X, Y, Z, A = read_data_hdf5(_path + fn)

    if X.shape[1] != 60 and X.shape[2] != 120 and X.shape[3] != 40 and Y.shape[1] != 1 and Z.shape[1] != 3 and A.shape[1] != 3:
        print('File...', fn, X.shape, Y.shape, Z.shape, A.shape)
