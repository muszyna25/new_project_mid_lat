...
MODEL='Model_A' # Change name when launching different---deeper CNN model (i.e., A, B, C, ..., F).
FILE=${MODEL}'.sh'
PAR_1=0
PAR_2=0
c=0
RANGE=201 # Max index---it corresponds to max number of train files in a list of hdf5 data files.
SHIFT=20 # No of hdf5 subfiles for data generator (streamer).
JUMP=200
