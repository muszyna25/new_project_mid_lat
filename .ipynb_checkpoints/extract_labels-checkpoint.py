...
if __name__ == "__main__":
    ...
    #out_path = '/global/cscratch1/sd/muszyng/ethz_data/project_atmo_block_datasets/generated_datasets/binary_masks_regions'
    out_path = '/global/cscratch1/sd/muszyng/ethz_data/project_atmo_block_datasets/generated_datasets/corrected_labels'
    ...
    #for i in range(1, len(df_list)):
        ...
        #plot_imgs(f_var[200], d_reg_bin_masks['NC']['X'][200])
        #plot_imgs(f_var[200], d_reg_bin_masks['NP']['X'][200])
        #plot_imgs(f_var[200], d_reg_bin_masks['NA']['X'][200])
        #plot_imgs(f_var[200], d_reg_bin_masks['SI']['X'][200])
        #plot_imgs(f_var[200], d_reg_bin_masks['SP']['X'][200])
        #plot_imgs(f_var[200], d_reg_bin_masks['SA']['X'][200])
